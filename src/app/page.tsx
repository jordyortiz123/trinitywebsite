...
const featuredRentals = [
  {
    ...
    titleEs: "Brincolines",
    desc: "Safe, clean & colorful bouncy castles for kids of all ages. Full day, minimum 4 hours.",
    descEs: "Brincolines seguros, limpios y coloridos para niños de todas las edades. Día completo, mínimo 4 horas.",
    price: "From $125/day",
  },
  {
    icon: "🌊",
  ...
  },
  {
    ...
    desc: "Coming soon! Sweet spun sugar to keep the little ones happy.",
    descEs: "¡Próximamente! Algodón de azúcar para alegrar a los pequeños.",
    price: "Coming Soon",
  },
  {
    icon: "📸",
    ...
    desc: "Coming soon! Backdrop, props & digital copies to capture the memories.",
    descEs: "¡Próximamente! Fondo, accesorios y copias digitales para capturar los recuerdos.",
    price: "Coming Soon",
  },
  {
    icon: "🔊",
