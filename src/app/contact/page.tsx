            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-fiesta-yellow/20">
                ...
                <div className="space-y-5">
                  ...
                  <a href="https://facebook.com/jordy.ortiz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-fiesta-cream rounded-xl hover:bg-blue-50 transition-colors">
                    <span className="text-3xl">👍</span>
                    <div>
                      <p className="font-bold text-fiesta-teal">Jordy Ortiz</p>
